...
public class Terrain_parcelle_culture_serve {
    ...
    @Autowired 
    public Terrain_parcelle_culture_serve(Terrain_serve terrain,Parcelle_serve parcelle,Categorie_culture_serve culture)
    {
        this.terrain = terrain;
        this.parcelle = parcelle;
        this.culture = culture;
    }   
    public List getTerrain_parcelle_culture() 
    {
